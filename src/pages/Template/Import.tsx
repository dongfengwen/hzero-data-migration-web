import { dataRule,dataApproval ,dataDifferencesDev,dataDifferencesProd} from '@/services/hzero-data-migration/api';
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<DATA.RuleListItem>[] = [
    ...
    //值集类型
    {
      title: (
        <FormattedMessage
          id="pages.lovView.table.lov.type.name"
          defaultMessage="Number of service calls"
        />
      ),
    ...
    //最后更新人
    {
      title: (
        <FormattedMessage
          id="pages.lovView.table.lov.lastUpdatedByName"
          defaultMessage="Number of service calls"
        />
      ),
      ...
      >
        <ProForm.Group>
          <ProTable<DATA.LovValueList>
            ...
            rowKey="lovValueId"
            request={()=>{
              return dataDifferencesDev({lovId:currentRowValue==undefined?-1:currentRowValue.devLovId})
            }}
            pagination={{
              showQuickJumper: true,
            }}
          ...
          <ProTable<DATA.LovValueList>
            ...
            rowKey="lovValueId"
            request={()=>{
              return dataDifferencesProd({lovId:currentRowValue==undefined?-1:currentRowValue.prodLovId})
            }}
            search={false}
            pagination={{
              showQuickJumper: true,
